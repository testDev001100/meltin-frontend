document.addEventListener("DOMContentLoaded", function () {
  ...
  const selfKeywordsSelect = document.getElementById("selfKeywords"); // 변경: input에서 select로
  ...
  form.addEventListener("submit", async function (e) {
    ...
    if (!matchingPreferenceSelect.value) {
      errorMessage.textContent = "성향선호를 선택해주세요.";
  ...
  async function sendSurveyData() {
    try {
      ...
      const surveyData = {
        ...
        selfKeywords: selfKeywordsSelect.value, // 변경: 선택된 값 사용
